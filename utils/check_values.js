function check_output_values() {
  ...
  if (
    get_quotation_request_value(array_quotation_request, "症例検討会") == "あり"
  ) {
    temp_value = 1;
  } else {
    temp_value = "";
  ...
  if (
    ...
    var temp_value = get_quotation_request_value(
      array_quotation_request,
      "統計解析に必要な図表数",
    );
  } else {
  ...
  if (
    ...
    var total_ammount = get_quotation_request_value(
      array_quotation_request,
      "研究協力費、負担軽減費",
    );
  } else {
